    ...
    <Card className="flex-row items-center justify-center bg-black shadow-[7px_7px_0px_#ffba00] p-4 outline-none border-none rounded-3xl dark:shadow-[7px_7px_0px_#758aef]">
      <div className="flex-1 flex-row flex items-center justify-start gap-3">
        <Button
          variant="ghost"
          size="icon"
          className="text-white hover:bg-neutral-500 hover:text-black w-9 h-9 rounded-xl dark:hover:bg-neutral-500"
          onClick={onMenuClick}
          title="Menu"
        >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="hover:bg-neutral-500 group rounded-xl dark:hover:bg-neutral-500"
          title="New Chat"
        >
          <Link to="/">
      ...
      <div className="flex-1 text-center">
        <h1 className="text-amber-400 text-5xl font-bold dark:text-[#758aef]">
          {children}
        </h1>
      </div>
      <div className="flex-1 flex items-center justify-end">
        <Button 
          className="bg-transparent w-11 h-11 hover:bg-neutral-500 rounded-2xl group" 
          size="icon"
          title="GitHub"
        >
          <a href="https://www.github.com/mflops" target="_blank" rel="noopener noreferrer">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              ...
              stroke="currentColor"
              strokeWidth="0.9"
              className="text-white group-hover:text-black transition-colors w-8 h-8"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
